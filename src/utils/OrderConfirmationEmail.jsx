const OrderConfirmationEmail = ({ name, plan, price, address }) => (
  <div style={{ fontFamily: 'Arial', padding: '20px', background: '#f5f5f5' }}>
    ...
    <p>Hi {name},</p>
    <p>Thanks for your BhauBox order. Here’s a quick summary:</p>
    <ul>
      <li><strong>Plan:</strong> {plan}</li>
      <li><strong>Price:</strong> {price}</li>
      <li><strong>Shipping Address:</strong><br />{address}</li>
    </ul>
    <p>We’re getting everything ready. You'll get another email when your BhauBox is on the way 🚚</p>
    <p style={{ marginTop: '30px' }}>With love,<br />The BhauBox Team</p>
  </div>
);
...
//     <p style="margin-top:30px;">Cheers,<br/>The BhauBox Team</p>
//   </div>
// `;
